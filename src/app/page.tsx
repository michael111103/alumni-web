...
import { Users, MapPin, Briefcase, Gift, ArrowRight, TrendingUp, ShoppingBag } from 'lucide-react'
    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="relative pt-16 overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 py-20 sm:py-28 text-center">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white mb-5 leading-tight animate-fade-up-delay-1">
            Direktori Alumni &<br />
            <span className="text-red-300">UMKM Komunitas</span>
          </h1>
          <p className="text-red-100 text-lg sm:text-xl mb-10 max-w-2xl mx-auto leading-relaxed animate-fade-up-delay-2">
          ...
          <div className="flex items-center justify-center gap-8 mt-12 animate-fade-up-delay-4">
            <div className="text-center">
              ...
              <div className="text-red-200 text-sm mt-0.5">Alumni</div>
            </div>
            <div className="w-px h-10 bg-white/20" />
            <div className="text-center">
              <div className="text-3xl font-extrabold text-white">{stats.totalUMKM.toLocaleString('id-ID')}</div>
              <div className="text-red-200 text-sm mt-0.5">UMKM</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 py-14">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            { href: '/alumni?filter=kota', icon: MapPin, title: 'Berdasarkan Kota', desc: 'Temukan alumni di kotamu', color: 'bg-red-50 text-red-700 border-red-100', iconBg: 'bg-red-100' },
            { href: '/alumni?filter=profesi', icon: Briefcase, title: 'Berdasarkan Profesi', desc: 'Cari berdasarkan bidang kerja', color: 'bg-gray-100 text-gray-700 border-gray-200', iconBg: 'bg-gray-200' },
            { href: '/alumni?filter=benefit', icon: Gift, title: 'Berdasarkan Benefit', desc: 'Alumni yang menawarkan benefit', color: 'bg-stone-100 text-stone-700 border-stone-200', iconBg: 'bg-stone-200' },
          ].map((item, i) => (
      ...
      <section className="bg-gray-50 py-14">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between mb-8">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <span className="text-sm font-semibold text-red-700 uppercase tracking-wide">Featured</span>
              </div>
            ...
            <Link href="/umkm" className="hidden sm:flex items-center gap-2 text-sm font-medium text-red-700 hover:text-red-800 transition">
          ...
          <div className="sm:hidden mt-6 text-center">
            <Link href="/umkm" className="inline-flex items-center gap-2 text-sm font-medium text-red-700">
      ...
      <section className="max-w-3xl mx-auto px-4 sm:px-6 py-16 text-center">
        <div className="bg-gradient-to-br from-red-800 to-gray-900 rounded-3xl p-8 sm:p-12 text-white relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full -translate-y-1/2 translate-x-1/2" />
          <Users className="w-10 h-10 text-red-300 mx-auto mb-4" />
          <h2 className="text-2xl sm:text-3xl font-bold mb-3">Bergabung dengan Komunitas</h2>
          <p className="text-red-100 mb-6 max-w-md mx-auto">Terhubung dengan ribuan alumni dan dukung usaha sesama.</p>
          <Link href="/alumni"
            className="inline-flex items-center gap-2 bg-white text-red-800 px-6 py-3 rounded-xl font-semibold hover:bg-red-50 transition">
      ...
      <footer className="border-t border-gray-100 py-8 px-4">
        <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-gray-400 text-sm">© {new Date().getFullYear()} TarkiPages. Platform komunitas alumni.</p>
