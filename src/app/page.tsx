         ...
         {[
           {
             ...
             icon: MapPin,
             title: 'Berdasarkan Kota',
             desc: 'Temukan alumni di kotamu',
           ...
           },
           {
             ...
             icon: Briefcase,
             title: 'Berdasarkan Profesi',
             desc: 'Cari berdasarkan bidang kerja',
           ...
           },
           {
             ...
             icon: Gift,
             title: 'Berdasarkan Benefit',
             desc: 'Alumni yang menawarkan benefit',
     ...
     <section className="bg-gray-50 py-14">
       <div className="max-w-6xl mx-auto px-4 sm:px-6">
         <div className="flex items-center justify-between mb-8">
           ...
           <Link
             href="/umkm"
             className="hidden sm:flex items-center gap-2 text-sm font-medium text-blue-600 hover:text-blue-700 transition"
           >
     ...
     <section className="max-w-3xl mx-auto px-4 sm:px-6 py-16 text-center">
       <div className="bg-gradient-to-br from-blue-600 to-blue-800 rounded-3xl p-8 sm:p-12 text-white relative overflow-hidden">
         ...
         <p className="text-blue-100 mb-6 max-w-md mx-auto">
           Terhubung dengan ribuan alumni dan dukung usaha sesama.
         </p>
         <Link
           href="/alumni"
     ...
     <footer className="border-t border-gray-100 py-8 px-4">
       <div className="max-w-6xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
         ...
         <p className="text-gray-400 text-sm">
           © {new Date().getFullYear()} TarkiPages. Platform komunitas alumni.
         </p>
