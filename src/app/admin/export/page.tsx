  ...
  const handleImport = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      for (const row of rows) {
        if (!row.nama_lengkap) { errors.push('Baris dilewati: nama kosong'); continue }
        ...
        if (error) errors.push(`${row.nama_lengkap}: ${error.message}`)
        else success++
      }
        ...
        <div className="pt-14 md:pt-0 mb-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-400 text-xs mt-0.5">Kelola data alumni dalam format Excel/CSV</p>
            </div>
          </div>
        </div>
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-4 sm:p-5">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs sm:text-sm text-gray-400 mb-4">Download semua data alumni dalam format Excel (.xlsx)</p>
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-4 sm:p-5">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs sm:text-sm text-gray-400 mb-4">Download template Excel untuk mengisi data alumni massal</p>
          ...
          <div className="bg-white border border-gray-100 rounded-2xl p-4 sm:p-5">
            <div className="flex items-start gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-xs sm:text-sm text-gray-400 mb-2">Upload file Excel (.xlsx) sesuai template untuk import massal</p>
                ...
                <label className={`inline-flex items-center gap-2 px-4 py-2 border-2 border-dashed border-gray-300 rounded-xl text-sm text-gray-600 hover:bg-gray-50 transition cursor-pointer ${importing ? 'opacity-60 pointer-events-none' : ''}`}>
